...
class HCMap {
	...
	tryAddEdge(tile0, tile1, edgeType) {
		if (this.type == MAP_TYPE.INDOOR_OUTDOOR &&
			tile0.type == MAP_TYPE.INDOOR &&
			(tile1 == null || tile1.type == MAP_TYPE.OUTDOOR)) {
